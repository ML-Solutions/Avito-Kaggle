...
if __name__ == "__main__":
    ...
    images = os.listdir("E:/Kaggle/Avito/imagestest/data/competition_files/test_jpg/")
    images = ['E:/Kaggle/Avito/imagestest/data/competition_files/test_jpg/'+image for image in images if image[-4:]=='.jpg']
    pool = Pool(4)
    ...
    processed_images.to_csv('E:/Kaggle/Avito/imagetest_features.csv',index=False)
    pool.close()